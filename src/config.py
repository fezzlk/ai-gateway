...
# Headless runs cannot prompt to create files; Edit alone does not allow Write.
CLAUDE_ALLOWED_TOOLS = os.environ.get("CLAUDE_ALLOWED_TOOLS", "Bash,Read,Write,Edit")
